...
.return_cls{
	...
	<body>
      ...
      <form class="SearchBar" action="action_page.php" style="margin-bottom: 5px;">
        ...
        <!-------------------------siderbar---End----------------------------->
		    ...
		    <?php
                ...
                //{
                   ...
                   $st=$conn->prepare("select * from orders where login_id=:id order by order_date desc");
		    ...
		    while($ft=$st->fetch())
                    ...
                    {?> 
                        ...
                        <div class=item_pic><div class='imgr'><img src="./image/<?php echo $ft['path']; ?>" height="350px" width="250px"></div></div>
		 ...
		 <form method="post" action="home.php">
				...
				<button type="buy" name="add" class="button_2">Re-order</button>
   			</div>
			<div class="rent_cls">
				<input type="hidden" name="order" value='<?php echo $ft['b_id'];?>'>
				<button type="rent" name="ord" class="button_3">Return</button>
			</div>
                ...
                <?php       
                 ...
                 extract($_POST);
                     ...
                     if(isset($ord)){
                     	...
                     	echo '<script>window.alert("Return Processed")</script>';
